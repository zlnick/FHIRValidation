...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/mdm-organizationTypeExtension']) &gt;= 1">extension with URL = 'http://example.org/StructureDefinition/mdm-organizationTypeExtension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/mdm-organizationTypeExtension']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/mdm-organizationTypeExtension': maximum cardinality of 'extension' is 1</sch:assert>
